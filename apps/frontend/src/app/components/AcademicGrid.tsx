...
import { ExternalLink, Clock, MapPin, GraduationCap, DollarSign } from 'lucide-react';
...
export function AcademicGrid({ data, loading = false, className = "" }: AcademicGridProps) {
  if (loading) {
    return (
