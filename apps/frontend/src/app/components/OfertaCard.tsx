...
export function OfertaCard({ oferta }: OfertaCardProps) {
  return (
    <article className='group bg-white border border-gray-200 rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 hover:border-blue-300 relative overflow-hidden'>
      ...
      <div className='relative z-10'>
        ...
        <div className='flex flex-wrap gap-2 mb-4'>
          ...
          <Tag
            ...
            color='green'
          />
          {oferta.jornada && <Tag text={oferta.jornada} color='purple' />}
        </div>
